...
public class ReadHeapExpression implements IExpression {
    ...
    public IValue evaluate(MyIDictionary<String, IValue> symbolTable, MyIHeap heapTable) throws InterpreterException {
        IValue innerExpressionValue = expressionToEvaluate.evaluate(symbolTable, heapTable);
        ...
        if (! (innerExpressionValue instanceof ReferenceValue expressionValue))
            throw new InterpreterException("Expression is not of type reference!");
        ...
        if (valueFound == null)
            throw new InterpreterException("The address is not allocated in heap table!");
