...
{
    return this->tutorialsList.getSize();
}
...
int TutorialsRepository::findPosition(string tutorialTitle, string tutorialPresenter)
{
    ...
    */
    ...
    {
        Tutorial currentTutorial = this->tutorialsList[i];
        if (currentTutorial.getTitle() == tutorialTitle &&
            currentTutorial.getPresenter() == tutorialPresenter)
            return i;
    }
...
void TutorialsRepository::addTutorial(Tutorial tutorialToAdd)
{
    ...
    this->tutorialsList.pushBack(tutorialToAdd);
}
...
DynamicArray<Tutorial> TutorialsRepository::getAllTutorials()
{
